...
_lr_productions = [
  ...
  ('vardecl -> VAR IDENT EQUALS expr COLON ty SEMICOLON','vardecl',7,'p_vardecl','parser.py',128),
  ...
  ('stmt -> RETURN expr SEMICOLON','stmt',3,'p_stmt_return','parser.py',148),
  ('stmt -> RETURN SEMICOLON','stmt',2,'p_stmt_return','parser.py',149),
  ('stmt -> call SEMICOLON','stmt',2,'p_stmt_eval','parser.py',157),
  ('stmt -> IDENT EQUALS expr SEMICOLON','stmt',4,'p_stmt_assign','parser.py',161),
  ('call -> IDENT LPAREN arglist RPAREN','call',4,'p_call','parser.py',166),
  ('call -> IDENT LPAREN RPAREN','call',3,'p_call','parser.py',167),
  ('expr -> call','expr',1,'p_expr_call','parser.py',173),
  ('arglist -> expr','arglist',1,'p_arglist','parser.py',177),
  ('arglist -> expr COMMA arglist','arglist',3,'p_arglist','parser.py',178),
  ('stmt -> IF LPAREN expr RPAREN block','stmt',5,'p_stmt_if_then','parser.py',190),
  ('stmt -> IF LPAREN expr RPAREN block ELSE block','stmt',7,'p_stmt_if_else','parser.py',196),
  ('stmt -> WHILE LPAREN expr RPAREN block','stmt',5,'p_stmt_while','parser.py',201),
  ('expr -> NUMBER','expr',1,'p_expr_number','parser.py',206),
  ('expr -> TRUE','expr',1,'p_expr_bool','parser.py',211),
  ('expr -> FALSE','expr',1,'p_expr_bool','parser.py',212),
  ('expr -> IDENT','expr',1,'p_expr_ident','parser.py',221),
  ('expr -> TILDE expr','expr',2,'p_expr_unop','parser.py',226),
  ('expr -> MINUS expr','expr',2,'p_expr_unop','parser.py',227),
  ('expr -> BANG expr','expr',2,'p_expr_unop','parser.py',228),
  ('expr -> LPAREN expr RPAREN','expr',3,'p_expr_parens','parser.py',239),
  ('expr -> expr ANDAND expr','expr',3,'p_expr_binop','parser.py',244),
  ('expr -> expr PLUS expr','expr',3,'p_expr_binop','parser.py',245),
  ('expr -> expr OROR expr','expr',3,'p_expr_binop','parser.py',246),
  ('expr -> expr MINUS expr','expr',3,'p_expr_binop','parser.py',247),
  ('expr -> expr TIMES expr','expr',3,'p_expr_binop','parser.py',248),
  ('expr -> expr DIVIDE expr','expr',3,'p_expr_binop','parser.py',249),
  ('expr -> expr EQUALSEQUALS expr','expr',3,'p_expr_binop','parser.py',250),
  ('expr -> expr MOD expr','expr',3,'p_expr_binop','parser.py',251),
  ('expr -> expr XOR expr','expr',3,'p_expr_binop','parser.py',252),
  ('expr -> expr AND expr','expr',3,'p_expr_binop','parser.py',253),
  ('expr -> expr OR expr','expr',3,'p_expr_binop','parser.py',254),
  ('expr -> expr LSHIFT expr','expr',3,'p_expr_binop','parser.py',255),
  ('expr -> expr RSHIFT expr','expr',3,'p_expr_binop','parser.py',256),
  ('expr -> expr LESSTHAN expr','expr',3,'p_expr_binop','parser.py',257),
  ('expr -> expr GREATERTHAN expr','expr',3,'p_expr_binop','parser.py',258),
  ('expr -> expr LESSTHANEQUALS expr','expr',3,'p_expr_binop','parser.py',259),
  ('expr -> expr GREATERTHANEQUALS expr','expr',3,'p_expr_binop','parser.py',260),
  ('expr -> expr NOTEQUALS expr','expr',3,'p_expr_binop','parser.py',261),
]
