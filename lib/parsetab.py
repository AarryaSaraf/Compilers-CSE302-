...
_lr_productions = [
  ...
  ('program -> DEF IDENT LPAREN RPAREN block','program',5,'p_program','parser.py',23),
  ('block -> LBRACE stmts RBRACE','block',3,'p_block','parser.py',27),
  ('stmts -> stmtstar','stmts',1,'p_stmts','parser.py',30),
  ('stmtstar -> <empty>','stmtstar',0,'p_stmtstar','parser.py',34),
  ('stmtstar -> stmtstar stmt','stmtstar',2,'p_stmtstar','parser.py',35),
  ('stmt -> VAR IDENT EQUALS NUMBER COLON INT SEMICOLON','stmt',7,'p_stmt_vardecl','parser.py',43),
  ('stmt -> PRINT LPAREN expr RPAREN SEMICOLON','stmt',5,'p_stmt_print','parser.py',47),
  ('stmt -> IDENT EQUALS expr SEMICOLON','stmt',4,'p_stmt_assign','parser.py',51),
  ('stmt -> IF LPAREN expr RPAREN block','stmt',5,'p_stmt_if','parser.py',56),
  ('stmt -> IF LPAREN expr RPAREN block ELSE block','stmt',7,'p_stmt_if','parser.py',57),
  ('stmt -> WHILE LPAREN expr RPAREN block','stmt',5,'p_stmt_while','parser.py',65),
  ('expr -> NUMBER','expr',1,'p_expr_number','parser.py',69),
  ('expr -> IDENT','expr',1,'p_expr_ident','parser.py',73),
  ('expr -> expr binop expr','expr',3,'p_expr_binop','parser.py',77),
  ('expr -> TILDE expr','expr',2,'p_expr_unop','parser.py',81),
  ('expr -> MINUS expr','expr',2,'p_expr_unop','parser.py',82),
  ('expr -> LPAREN expr RPAREN','expr',3,'p_expr_parens','parser.py',89),
  ('unop -> MINUS','unop',1,'p_unop_opp','parser.py',93),
  ('unop -> BANG','unop',1,'p_unop_bopp','parser.py',97),
  ('unop -> TILDE','unop',1,'p_unop_neg','parser.py',101),
  ('binop -> PLUS','binop',1,'p_binop_plus','parser.py',106),
  ('binop -> ANDAND','binop',1,'p_binop_plus','parser.py',107),
  ('binop -> OROR','binop',1,'p_binop_plus','parser.py',108),
  ('binop -> MINUS','binop',1,'p_binop_plus','parser.py',109),
  ('binop -> TIMES','binop',1,'p_binop_plus','parser.py',110),
  ('binop -> DIVIDE','binop',1,'p_binop_plus','parser.py',111),
  ('binop -> MOD','binop',1,'p_binop_plus','parser.py',112),
  ('binop -> XOR','binop',1,'p_binop_plus','parser.py',113),
  ('binop -> AND','binop',1,'p_binop_plus','parser.py',114),
  ('binop -> OR','binop',1,'p_binop_plus','parser.py',115),
  ('binop -> LSHIFT','binop',1,'p_binop_plus','parser.py',116),
  ('binop -> RSHIFT','binop',1,'p_binop_plus','parser.py',117),
  ('binop -> LESSTHAN','binop',1,'p_binop_plus','parser.py',118),
  ('binop -> GREATERTHAN','binop',1,'p_binop_plus','parser.py',119),
  ('binop -> LESSTHANEQUALS','binop',1,'p_binop_plus','parser.py',120),
  ('binop -> GREATERTHANEQUALS','binop',1,'p_binop_plus','parser.py',121),
  ('binop -> EQUALSEQUALS','binop',1,'p_binop_plus','parser.py',122),
  ('binop -> NOTEQUALS','binop',1,'p_binop_plus','parser.py',123),
]
